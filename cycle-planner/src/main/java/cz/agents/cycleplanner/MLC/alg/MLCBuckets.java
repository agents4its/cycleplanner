...
public class MLCBuckets<TNode extends Node, TEdge extends Edge> extends MLC<TNode, TEdge> {
	...
	public MLCBuckets(Graph<TNode, TEdge> graph, TNode origin, TNode destination, MLCCostFunction<TNode, TEdge> costFunction) {
