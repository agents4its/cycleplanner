...
public class MLCEllipseCostPruning<TNode extends Node, TEdge extends Edge> extends MLCEllipse<TNode, TEdge> {
	...
	public MLCEllipseCostPruning(Graph<TNode, TEdge> graph, TNode origin, TNode destination, MLCCostFunction<TNode, TEdge> costFunction) {
