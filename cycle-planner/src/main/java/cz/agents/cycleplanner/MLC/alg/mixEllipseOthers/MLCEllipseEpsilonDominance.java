...
public class MLCEllipseEpsilonDominance<TNode extends Node, TEdge extends Edge> extends MLCEllipse<TNode, TEdge> {
	...
	public MLCEllipseEpsilonDominance(Graph<TNode, TEdge> graph, TNode origin, TNode destination, MLCCostFunction<TNode, TEdge> costFunction) {
