...
public class MLCEllipseRatioPruningCostPruning<TNode extends Node, TEdge extends Edge> extends MLCEllipseRatioPruning<TNode, TEdge> {
	...
	public MLCEllipseRatioPruningCostPruning(Graph<TNode, TEdge> graph, TNode origin, TNode destination, MLCCostFunction<TNode, TEdge> costFunction) {
