...
public class MLCRatioPruningBuckets<TNode extends Node, TEdge extends Edge> extends MLCRatioPruning<TNode, TEdge> {
	...
	public MLCRatioPruningBuckets(Graph<TNode, TEdge> graph, TNode origin, TNode destination, MLCCostFunction<TNode, TEdge> costFunction) {
