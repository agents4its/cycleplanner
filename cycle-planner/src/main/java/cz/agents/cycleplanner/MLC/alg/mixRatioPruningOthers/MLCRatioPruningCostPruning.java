...
public class MLCRatioPruningCostPruning<TNode extends Node, TEdge extends Edge> extends MLCRatioPruning<TNode, TEdge> {
	...
	public MLCRatioPruningCostPruning(Graph<TNode, TEdge> graph, TNode origin, TNode destination, MLCCostFunction<TNode, TEdge> costFunction) {
