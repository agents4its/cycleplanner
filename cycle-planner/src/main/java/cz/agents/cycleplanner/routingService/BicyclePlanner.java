...
import cz.agents.cycleplanner.aStar.JGraphT.PseudoMultiCriteriaAStarSearchJGraphT;
...
public final class BicyclePlanner implements Planner<Response, Request> {
	...
	public Response plan(Request request) {
		...
		// AIMA
		// AStarSearch search = new PseudoMultiCriteriaAStarSearchAIMA(profile,
		// averageSpeedKMpH);
		// JGraphT
		AStarSearch search = new PseudoMultiCriteriaAStarSearchJGraphT(request.getProfile(), request.getAverageSpeed());
