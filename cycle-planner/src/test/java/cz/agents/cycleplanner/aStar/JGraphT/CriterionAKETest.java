...
public class CriterionAKETest {
	...
	public void testTravelTime() {
		...
		CriterionAKE ake = new CriterionAKE(profile, averageSpeedKMpH);	
		TimedNode timeNode = new TimedNode(edgeToTake.getFromNode(), null, 0, 0, 0, ModeOfTransport.BIKE, null, edgeToTake);
		double actual = ake.computeAdditionalKey(timeNode, null, edgeToTake);
