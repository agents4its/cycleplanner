...
/**
 * An aspect which evaluates the edge from the comfort point of view
 * @author Marcel Német <marcel.nemet@gmail.com>
 */
public class ComfortAspect extends AbstractAspect  {

    private static final ParametersOfRelevantTags evaluationParameters;
    private static final double maximumValue;
    private static final double downhillMaxSpeedup = 0.2;
    ...
    static {
        ...
        evaluationParameters = new ParametersOfRelevantTags(f, 0, 1, 2, 5, 6);
        double max = -1;
    ...
    public EdgeEvaluator getEvaluator(CycleEdge edge) {
        return new DefaultEdgeEvaluator(edge, evaluationParameters, true, 20, downhillMaxSpeedup);
    }
/**
 * returns "ComfortAspect"
 * @return String "ComfortAspect"
 */
    @Override
    public String toString() {
        return "ComfortAspect"; //To change body of generated methods, choose Tools | Templates.
    }
}
