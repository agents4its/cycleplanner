 ...
 */
public class JsonRouteCreator {
/**
 * creates a string in GeoJSON format that represent a path from provided nodes. 
 * A path is wrapped in a GeoJSON feature.
 * @param nodes nodes that specify the path
 * @return string in JSON format that represent a path
 * @throws JSONException 
 */
    public static String createJsonPath(Collection< CycleNode> nodes) throws JSONException {
