...
//    @Override
//    TODO replace
    public TNode getNearestNodeNew(Location location) {
    	
        double referenceLat = location.getProjectedLatitude();
        double referenceLon = location.getProjectedLongitude();
        ...
        for (int i = 0; i < nodes.size(); i++) {
            ...
            double dist = GeoCalculationsHelper.distanceE2Squared(
                    ...
                    node.getProjectedLatitude(), node.getProjectedLongitude() );
