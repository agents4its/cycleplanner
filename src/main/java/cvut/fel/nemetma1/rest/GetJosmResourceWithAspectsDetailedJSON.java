 ...
 * @author Marcel
 */
@Path("getJosmAspectsDetailed")
public class GetJosmResourceWithAspectsDetailedJSON {
     ...
     */
    public GetJosmResourceWithAspectsDetailedJSON() {
    }
    ...
    public String getJson(@QueryParam("startLat") String startLat, @QueryParam("startLon") String startLon,
        ...
        return routingServiceSingleton.findRouteJOSMLatLonWithAspectsDetailed(
