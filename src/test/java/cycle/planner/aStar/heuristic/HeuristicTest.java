...
public class HeuristicTest {
	...
	public void setUp() throws Exception {
		...
		goal = new CycleNode(0, projection.getProjectedGPSLocation(new GPSLocation(50.102775, 14.383461)), "TEST", 400);
		state = new CycleNode(1, projection.getProjectedGPSLocation(new GPSLocation(50.091928, 14.380028)), "TEST", 300);
	...
	public void testTravelTime() {
		...
		Heuristic heuristic = new Heuristic(goal, profile, averageSpeedMetersPerSecond);
